            ...
            {questions.length === 0 ? (
              ...
              <div className="space-y-4">
                      ...
                      <div className="grid gap-2">
                        {q.options?.map((opt: any) => (
                          <Button
                            ...
                            variant={answers[q.id] === opt.id ? "default" : "ghost"}
                          >
                            {opt.text}
                          </Button>
                        ))}
                ...
                <div className="flex gap-2">
                  <Button
                    onClick={() => startMutation.mutate(selectedSkill.id)}
                    disabled={!!assessmentId}
                  >
                    Start
                  </Button>
                  <Button onClick={() => submitMutation.mutate()} disabled={!assessmentId}>
                    Submit
                  </Button>
                </div>
              </div>
